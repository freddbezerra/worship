...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post musics_url, params: { music: { author: @music.author, bgLink: @music.bgLink, bpm: @music.bpm, imgLink: @music.imgLink, name: @music.name, notesLink: @music.notesLink, videoLink: @music.videoLink } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { author: @music.author, bgLink: @music.bgLink, bpm: @music.bpm, imgLink: @music.imgLink, name: @music.name, notesLink: @music.notesLink, videoLink: @music.videoLink } }
